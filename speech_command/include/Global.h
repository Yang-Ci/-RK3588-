...
const char *pcm_name = "hw:2,0";                                             // 选择使用的设备型号
...
string appid = "dacb588f";                                               // 仅用于在线AIUI，用户可修改，普通用户每天500次
string key = "8899082b0b85ace67cd84337c2cf0085";                         // AIUI引擎Appid对应的AppKey
string offline_appid = "appid = dacb588f";					 //仅用于离线命令词识别I，用户可修改.
