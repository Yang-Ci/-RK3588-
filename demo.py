...
if __name__ == "__main__":
    ...
    fps = round(1000000 / (duration.microseconds + 1)) # 防止除0
    ...
    cv2.imshow("post process result", img_draw)
    cv2.imwrite('output_bananadata335.jpg', img_draw)
    cv2.waitKey(0)
